...
final class SyncGoogleCalendarController extends AbstractController
{
    ...
    public function __invoke(#[CurrentUser] User $user, Request $request): JsonResponse
    {
        ...
        try {
            $this->googleCalendarService->syncEvents($user, $calendar);
            return $this->json(['message' => 'Calendar synced successfully']);
        } catch (Exception $e) {
